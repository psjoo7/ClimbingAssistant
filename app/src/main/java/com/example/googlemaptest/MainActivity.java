...
public class MainActivity extends AppCompatActivity
    ...
    private Marker currentMarker = null; // 현재 위치를 나타내는 마커
    private Marker mountainMarker = null; // 봉우리들을 나타내는 마커
...
//        mMap.animateCamera(CameraUpdateFactory.zoomTo(30));
    ...
    /**
     * onMapReady에서 호출되는 method (onMapReady에서 퍼미션 체크를 모두 한뒤)
     * 역할 : 위치 업데이트를 시작함
     */
    ...
    //봉우리 생성 마커
    public void setMarker(String lat, String lot, String aslAltide, String frtrlNm, String placeNm){
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(new LatLng(Double.parseDouble(lat), Double.parseDouble(lot)));
        markerOptions.title(frtrlNm + " " + placeNm);
        markerOptions.snippet("위도 : " + lat + " 경도 : " + lot + " 해발고도 : " + aslAltide);
        markerOptions.draggable(false);

        mountainMarker = mMap.addMarker(markerOptions);
